<template>
    <el-container class="container" direction="horizontal">
        <el-aside class="aside" width="110px">
            ...
            <el-menu :default-active="defaultActive" background-color="#1b273f" :unique-opened="true"
                text-color="#DCDFE6" router>
        ...
        <el-container direction="vertical">
            <el-header class="header">
                <div class="navbar">
                    <el-icon size="20px" style="padding: 5px;cursor: pointer;" @click="refresh">
                        <RefreshRight />
                    </el-icon>
                </div>
                <div class="avatar">
                    <div class="operate">
                        <el-icon size="20px" @click="onFullscreen" style="cursor: pointer;padding: 10px;">
                            <FullScreen />
                        </el-icon>
                        <el-icon size="20px" style="cursor: pointer;padding: 10px;">
                            <Bell />
                        </el-icon>
                        <el-icon size="20px" @click="feedbackPopoverVisible = true"
                            ...
                            <el-dropdown-menu>
                                <div style="text-align: center;">
                                    <el-avatar :size="45" :src="avatarURL"
                                        style="cursor: pointer;border: 1px solid #d9ecff;" />
                                    <div>SID: {{  sid  }}</div>
                                </div>
            ...
            <el-menu :default-active="defaultNav" class="el-menu-demo" v-if="navigation.length > 0" mode="horizontal"
                router>
                <el-menu-item v-for="item in navigation" :key="item.index" :index="item.index">{{  item.name  }}
                </el-menu-item>
            </el-menu>
            <el-main class="main">
...
export default {
    name: "Home",
    components: {
        RefreshRight, Service, FullScreen, Bell, HomeFilled,
        GoodsFilled,
        List,
        Ticket
    },
