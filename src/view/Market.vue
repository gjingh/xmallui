            ...
            <el-table-column label="操作">
                <template #default="scope">
                    ...
                    <el-popconfirm title="此操作将永久删除该信息, 是否继续?" confirmButtonText="确认" cancelButtonText="取消"
                        cancelButtonType="default" :icon="WarningFilled" @confirm="deleteMarket(scope.row)">
                        <template #reference>
        ...
        <el-dialog :title="dialogTitle" v-model="marketDialogVisible" :lock-scroll="false" top="5vh" width="45%"
            ...
            <el-form ref="ruleForm" :rules="rules" :model="market" label-width="80px">
                ...
                <el-form-item label="开始时间" prop="beginTime">
                    <el-date-picker v-model="market.beginTime" value-format="YYYY-MM-DD HH:mm:ss" type="datetime"
                        placeholder="请选择开始时间" />
                </el-form-item>
                <el-form-item label="结束时间" prop="overTime">
                    <el-date-picker v-model="market.overTime" value-format="YYYY-MM-DD HH:mm:ss" type="datetime"
                        placeholder="请选择结束时间" />
                </el-form-item>
                        ...
                        <el-table-column align="right">
                            <template #header>
                                <el-popover placement="left" :width="350" trigger="click"
                                    :visible="goodsPopoverVisible">
                                    <template #reference>
                                        <el-button size="small" type="primary" :icon="Plus" @click="addGoods" />
                                    </template>
                                    <el-table :data="goodsList" height="30vh" style="width: 100%"
                                        @select="selectedGoodsIds">
                                        ...
                                        <el-table-column prop="title" label="标题">
                                            <template #default="scope">
                                                <div style="font-size: 10px;line-height: 15px;">{{ scope.row.title }}
                                                </div>
                                            </template>
                                        </el-table-column>
                                        <el-table-column prop="price" label="价格" width="80">
                                    ...
                                    <div style="text-align: right; margin: 0;padding-top: 10px;">
                                        ...
                                        <el-button size="small" type="primary" @click="confirmSelectedGoods">确定
                                        </el-button>
                                    </div>
                                </el-popover>
                            </template>
                            <template #default="scope">
                                <el-button size="small" type="danger" :icon="Minus"
                                    @click="removeSelectedGoods(scope.row)" />
                            </template>
                        </el-table-column>
                    </el-table>
                </el-form-item>
