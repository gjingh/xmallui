        ...
        <el-table :data="orderList" height="65vh" style="width: 100%">
            ...
            <el-table-column label="操作" min-width="130">
                <template #default="scope">
                    ...
                    <el-button v-if="scope.row.status === 3" size="small" type="primary"
                        @click="modifyOrder(scope.row, 4)">配送</el-button>
                    <el-popconfirm title="此操作将永久删除该信息, 是否继续?" confirmButtonText="确认" cancelButtonText="取消"
                        cancelButtonType="default" v-if="scope.row.status === 2 || scope.row.status === 5"
